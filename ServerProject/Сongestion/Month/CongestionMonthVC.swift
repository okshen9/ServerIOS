//
//  CongestionMonthVC.swift
//  ServerProject
//
//  Created by Artem Neshko on 4/24/20.
...
class CongestionMonthVC: TCLViewController {
    ...
    typealias Section = CongestionViewModel.SectionModel
    typealias Item = CongestionViewModel.ItemModel
    
    let viewModel = CongestionViewModel()
        ...
        self.ibCollectionView.rx.itemSelected
            .subscribe(onNext: { [unowned self] indexPath in
                ...
                case .hallItem(hall: let hall, _, _):
                    Router.week(hall: hall).push(from: self.navigationController)
                default: break
...
extension CongestionMonthVC: UICollectionViewDelegateFlowLayout {
